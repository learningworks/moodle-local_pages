...
$string['validemail'] = 'Please supply a valid email address for {$a->email}';
$string['pleasefillin'] = 'Please fill in {a->name}';
$string['pleasefillinnumber'] = 'Please give a number for {$a->name}';